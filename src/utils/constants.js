...
export const editPopup = document.querySelector('#editButton');
...
export const bigPicrure = document.querySelector('.popup__picture');                       
export const bigPictureName = document.querySelector('.popup__name');                     
//  переменные для добавления 6 стандартных карточек карточек 
export const templateCards = document.querySelector('.elements');             
// переменные для попапа новых карточек
export const buttonOpenCardPopup = document.querySelector('.profile__add-button');
export const cardPopup = document.querySelector('#addButton');
export const buttonCloseCardPopup = document.querySelector('.popup__close-button_add');
export const buttonAddNewCard = document.querySelector('#addCardButton');
